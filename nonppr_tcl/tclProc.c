 ...
 */
	...
	/* ARGSUSED */
int
Tcl_ProcCmd(ClientData dummy, Tcl_Interp *interp, int argc, char **argv)
                     			/* Not used. */
                       			/* Current interpreter. */
             				/* Number of arguments. */
                			/* Argument strings. */
...
int
TclGetFrame(Tcl_Interp *interp, char *string, CallFrame **framePtrPtr)
 ...
 */
	...
	/* ARGSUSED */
int
Tcl_UplevelCmd(ClientData dummy, Tcl_Interp *interp, int argc, char **argv)
                     			/* Not used. */
                       			/* Current interpreter. */
             				/* Number of arguments. */
                			/* Argument strings. */
...
static int
InterpProc(ClientData clientData, Tcl_Interp *interp, int argc, char **argv)
...
static void
ProcDeleteProc(ClientData clientData)
...
static void
CleanupProc(register Proc *procPtr)
                           		/* Procedure to be deleted. */
{
    register Arg *argPtr;
...
int
TclUpdateReturnInfo(Interp *iPtr)
                 		/* Interpreter for which TCL_RETURN
