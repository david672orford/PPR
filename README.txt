...
The source code is divided into directories as follows:
	...
	autoconf/
		GNU autoconf build files, non working.
	templates/
	...
	pprdrv/
		...
		drive a printer.
	interfaces/
		Programs which pprdrv runs to communicate with the printer.
	libppr_int/
		A library of routines used by the programs in interfaces/.
	ppr/
