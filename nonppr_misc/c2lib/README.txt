...
It has been stript down by removing the build system, documentation, and test
suite, added config.h (generated by the deleted system) and editing the
files to find config.h in this directory.
