...
seen by running B<ppad show>, B<ppad group show>, or B<ppad alias show>)

To learn how the implied options are implied, see the sections about the
B<-F> and B<-R> options.  They do the implying.
